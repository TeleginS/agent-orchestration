...
Keep findings with unconfirmed origin explicitly marked in the blocking list until
classified. Apply `pre-existing` only with the evidence your role requires.
