---
name: code-reviewer
description: "Independently review implementation changes and return a blocking or approval verdict."
model: sonnet
context: fork
...
`<library-root>/skills/code-reviewer/SKILL.md`, and apply that skill to this invocation:
