---
name: qa-tester
description: "Independently verify reviewed changes against acceptance criteria and run the test suite."
model: sonnet
context: fork
...
`<library-root>/skills/qa-tester/SKILL.md`, and apply that skill to this invocation:
